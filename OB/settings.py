...
SECRET_KEY = 'django-insecure-($)_nj!!&po--6h9twm*c$#n%n8c66yfjd5^=hi2#^)cq^yfmu'
...
TEMPLATES = [
    {
        ...
        'DIRS': [],  # If your templates are in the app's template directory, this can be empty
...
DATABASES = {
    'default': {
        ...
        'NAME': 'OBPagsasarili2',  # Database name
...
ASGI_APPLICATION = 'OB.asgi.application'
